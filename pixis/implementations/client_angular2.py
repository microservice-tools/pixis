...
class Angular2(Implementation):
    ...
    def generate_once():
        ...
        tmpl.emit_template('client_angular2/api_ts.j2', cfg.Config.PATH_OUT + '/api', 'api.ts')
        tmpl.emit_template('client_angular2/models.j2', cfg.Config.PATH_OUT + '/model', 'models.ts')
    ...
    def generate_per_tag():
        tmpl.emit_template('client_angular2/service.j2', cfg.Config.PATH_OUT + '/api', tmpl.TEMPLATE_CONTEXT['_current_tag'] + '.service.ts')

    @staticmethod
    def generate_per_schema():
        tmpl.emit_template('client_angular2/model.j2', cfg.Config.PATH_OUT + '/model', tmpl.TEMPLATE_CONTEXT['_current_schema'] + '.ts')
