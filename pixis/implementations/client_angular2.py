...
class Angular2(Implementation):
    ...
    def generate_once():
        ...
        tmpl.emit_template('client_angular2/api_ts.j2', cfg.Config.PATH_OUT + os.path.sep + 'api', 'api.ts')
        tmpl.emit_template('client_angular2/models.j2', cfg.Config.PATH_OUT + os.path.sep + 'model', 'models.ts')
        tmpl.emit_template('client_angular2/encoder.j2', cfg.Config.PATH_OUT, 'encoder.ts')
        tmpl.emit_template('client_angular2/api_module.j2', cfg.Config.PATH_OUT, 'api.module.ts')
        tmpl.emit_template('client_angular2/rxjs.j2', cfg.Config.PATH_OUT, 'rxjs-operators.ts')

    @staticmethod
    def generate_per_tag():
        tmpl.emit_template('client_angular2/service.j2', cfg.Config.PATH_OUT + os.path.sep + 'api', tmpl.TEMPLATE_CONTEXT['_current_tag'] + '.service.ts')

    @staticmethod
    def generate_per_schema():
        tmpl.emit_template('client_angular2/model.j2', cfg.Config.PATH_OUT + os.path.sep + 'model', tmpl.TEMPLATE_CONTEXT['_current_schema'] + '.ts')
